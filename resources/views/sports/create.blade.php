...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Add New Sports House</h6>
        </div>

        <div class="card-body">
            <form action="/add/sport-house" method="post" enctype="multipart/form">
                @csrf
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="firstname">House Name</label>
                        <input type="text" class="form-control" name="sport_house" required>
                    </div>
                    <div class="form-group col-md-6">
